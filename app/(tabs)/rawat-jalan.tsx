...
import { ChevronLeft, Search, Activity, CreditCard, Layers } from 'lucide-react-native';
...
export default function RawatJalanScreen() {
  ...
  const fetchPage = async (
    ...
    try {
      ...
      const response = await api.master.list('jns_perawatan', params);
      ...
      console.error('Error fetching jns_perawatan:', error);
      if (options.reset) {
        setData([]);
      }
    } finally {
    ...
    <TouchableOpacity style={styles.card}>
      ...
      <View style={styles.cardFooter}>
        <View style={styles.infoCol}>
          ...
          <Text style={styles.infoLabel}>{item.nm_kategori || 'Kat. Umum'}</Text>
        </View>
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>Layanan Rawat Jalan</Text>
      </LinearGradient>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchWrapper}>
          ...
          <TextInput
            ...
            placeholder="Cari jenis perawatan..."
            value={search}
